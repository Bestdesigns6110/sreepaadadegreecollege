...
<title>sreepaadadegreecollege</title>
...
<link href="./assets/css/flaticon_liggeet.php" rel="stylesheet">
...
<link href="assets/css/elements-css/program.css" rel="stylesheet">
<link href="assets/css/elements-css/studies.css" rel="stylesheet">
<link href="assets/css/elements-css/blog.css" rel="stylesheet">
<link href="assets/css/elements-css/event.css" rel="stylesheet">
...
<header class="main_header">
    <!-- Header Middle -->
    <div class="header_middle_style_one">
        <div class="container">
            <div class="header_middle_inner">
                <div class="header_middle_logo">
                    <figure>
                        <a href="index.php"><img src="Sree paada@2x.png" alt=""></a>
                    </figure>
                </div>
                <div class="header_middle_info">
                    ...
                    <div class="phone_info">
                        ...
                        <div class="icon-text">
                            <strong>Email</strong>
                            <a href="tel:+12345678900">sreepaada.ug@gmail.com</a>
                        </div>                        
                    </div>
                    <div class="phone_info">
                        <div class="icon-box">
        ...
        <div class="container"> 
            <div class="header_lower_inner">
                ...
                <div class="header_lower_right">
                    <a href="admission.php" class="button-style-one">Admission</a>
                </div> 
            </div>
        </div>
    </div>
    ...
    <div class="sticky_header">
        <div class="container">     
            <div class="header-outer-box">
                <div class="logo-box">
                    <figure class="logo"><a href="index.php"><img src="Sree paada@2x.png" alt=""></a></figure>
                </div>
                <div class="menu-area">
                    <nav class="main-menu navbar-expand-md navbar-light">
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.php"><img src="assets/images/Sree paada@2x.png" alt="" title=""></a></div>
